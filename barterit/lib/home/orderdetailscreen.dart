...
import 'package:lab_assignment_2/models/orderdetail.dart';
...
class _OrderDetailsScreenState extends State<OrderDetailsScreen> {
                        ...
                        child: Padding(
                          ...
                          child: Row(children: [
                            CachedNetworkImage(
                              ...
                              fit: BoxFit.cover,
                              imageUrl:
                                  "${MyConfig().server}/assets/items/${orderdetailsList[index].itemId}_1.png",
  ...
  void loadorderdetails() {
    http.post(Uri.parse("${MyConfig().server}/php/load_orderdetails.php"),
        body: {
